...
c = [person.name for person in humans if person.name.startswith(tuple(['C','D','E','F','G']))]
print(c)
...
f = [(person.name, person.age) for person in humans if ((person.age >= 27) & (person.age <= 32))]
print(f)
